...
//			}
//		}
		String m ="Martin Martinez Nuñez";
		String m2 = m.replaceAll("[^a-zA-Z,ñ,Ñ]", "");// quita espacios y numeros
		m2=m2.toLowerCase(); //convierte todo a minusculas
		String consonantes = m2.replaceAll("[a,á,e,é,i,í,o,ó,u,ú]", "");//se crea una variable con solo constantes
		String vocales = m2.replaceAll("[^a,á,e,é,i,í,o,ó,u,ú]", "");
